...
export interface TextRevealProps {
  ...
  className?: string;
  style?: CSSProperties;
  /** Font size (default: 3rem) */
  fontSize?: string;
  /** Stagger delay per character in ms (default: 25ms) */
  staggerDelay?: number;
  /** Transition duration in ms (default: 250ms) */
  duration?: number;
...
/**
 * TextReveal — hover-based text cascade animation.
 *
 * Mathematical model:
 *   delay(i) = i × staggerDelay
 *   y(i, hovered) = hovered ? -sign × fontSize : 0
 *
 * Where:
 *   i = character index
 *   staggerDelay = 25ms (stagger-fast)
 *   sign = 1 (up) or -1 (down)
 */
